...
const FilterByRoom = () => {
  ...
  const [roomIdOrCode, setRoomIdOrCode] = useState("R002"); // Giá trị mặc định từ API
  ...
  // Hàm gọi API
  const fetchSessionsByRoom = useCallback(async () => {
    if (!roomIdOrCode.trim()) {
      setError("Please enter Room ID or Room Code");
      return;
    }
    ...
    try {
      ...
      console.log("Making API call with:", {
        roomIdOrCode: roomIdOrCode.trim(),
        params
      });

      // Call the API
      const data = await getSessionsByRoomWithParams(roomIdOrCode.trim(), params);
      ...
      if (data && typeof data === 'object') {
        ...
        if (sessionsData.length === 0) {
          console.log("API call successful but no sessions found for room:", roomIdOrCode.trim());
        }
        
        console.log("Fetched sessions by room:", {
          roomIdOrCode: roomIdOrCode.trim(),
          params,
          sessionsCount: sessionsData.length,
          total: totalItems
      ...
      console.error("Error fetching sessions by room:", err);
      ...
      if (err.response) {
        ...
        if (status === 404) {
          errorMessage = `Room "${roomIdOrCode}" not found.`;
        } else if (status === 400) {
  ...
  }, [roomIdOrCode, page, limit, sortBy, sortOrder]);
  ...
  }, [roomIdOrCode, page, sortBy, sortOrder, fetchSessionsByRoom]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Filter Game Sessions by Room
          </h1>
          <p className="text-gray-600">
            Search and filter game sessions by Room ID or Room Code
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
              ...
              <div className="col-span-1 md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Room ID or Room Code <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Enter Room ID or Room Code (e.g: R002)"
            ...
            <div className="flex flex-wrap gap-3">
              <button
                type="submit"
                disabled={loading || !roomIdOrCode.trim()}
        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="p-6">
            ...
            {!loading && !error && sessions.length === 0 && roomIdOrCode && (
              <div className="text-center py-8">
                <svg className="mx-auto h-12 w-12 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <p className="text-gray-600 mb-2">No game sessions found for room "{roomIdOrCode}"</p>
            ...
            {!loading && !error && sessions.length === 0 && !roomIdOrCode && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Enter Room ID or Room Code to search</p>
              </div>
            )}

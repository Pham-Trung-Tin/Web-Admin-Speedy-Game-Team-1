...
const Admin = () => {
  ...
  const handleTabChange = (event) => {
    const { tab, session } = event.detail || {};
      ...
      <div className="page-header">
        <div className="page-title-section">
          <h1 className="page-title">
           {typeof activeTab === "string" ? activeTab : "SessionDetail"}
         </h1>
  ...
  {activeTab === 'SessionDetail' && renderSessionDetail()}  {/* 👉 SessionDetail sẽ hiển thị ở đây */}
  ...
  {/* Nếu tab không match bất kỳ case nào phía trên thì mới hiển thị Coming Soon */}
  {![
    'Dashboard',
    'GameRooms',
    'CreateRoom',
